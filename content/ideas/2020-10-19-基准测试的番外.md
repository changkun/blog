...
title: "Benchmark Testing: The Extras"
title_zh: "基准测试的番外"
---

{{% en %}}
Many people have written benchmark tests. In Go Nightly Reading Episode 83, [Reliable Performance Testing for Go Programs](https://talkgo.org/t/topic/102), we shared how to use tools like benchstat and perflock for rigorous and reliable performance testing. That session briefly discussed the measurement methodology and implementation principles of benchmarks, but due to time constraints, the coverage wasn't deep enough. So today, let's further share two details that weren't covered in Episode 83, but are easily overlooked in certain strict testing scenarios:
