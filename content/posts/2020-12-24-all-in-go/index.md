...
<img src="lamp.jpeg" alt="The LAMP Stack"/>
...
<div style="margin: 0 auto; max-width: 60%; text-align: center;">
<img src="hexo.jpg" alt="The Hexo + GitHub Pages Stack"/>
...
<div style="margin: 0 auto; max-width: 60%; text-align: center;">
<img src="https.png" alt="HTTPS is now required"/>
...
<div style="margin: 0 auto; max-width: 60%; text-align: center;">
<img src="https2.png" alt="HTTPS is now required"/>
<strong>Figure 3: HTTPS is now required</strong>
</div>
        ...
        try:
            with open(fix['path'], 'r', encoding='utf-8') as f:
                ...
                try:
                    ...
                    content = content.replace('](..images/posts/')
                    content = content.replace(
                        'images/posts/' + str(fix['id']))
                except Exception as e:
