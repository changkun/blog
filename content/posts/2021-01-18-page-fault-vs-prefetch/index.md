...
tags:
    ...
    - Go
    - 内存管理
title: "Performance Differences from Page Faults vs. Prefetching"
title_zh: "缺页与预取带来的性能差异"
---
...
Using the [bench](https://golang.design/s/bench) tool, we can run and obtain the following results:
...
This is rather interesting. Why does this happen? When kernel support for `MADV_FREE` was added, there was a [mailing list discussion](https://lwn.net/Articles/591214/) about it:
