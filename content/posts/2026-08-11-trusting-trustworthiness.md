...
Two kinds of reliance need names. The first is assurance: I rely on you because a mechanism I can inspect leaves you no room to act otherwise. The second is trust: I rely on you inside a space of discretion that no mechanism I can inspect closes off. Niklas Luhmann drew a similar line between confidence, which does not consider alternatives, and trust, which has weighed the risk and accepted it [Luhmann, 1979; Luhmann, 1988]. Assurance is the product of checking. Thompson's argument is that assurance at any layer rests on trust at the next one down.

Susan Shapiro made the same observation about institutions. Audits, licenses, guarantees, insurance, and oversight boards do not eliminate trust. They move it to the guardians who operate the controls, and the guardians then need guardians [Shapiro, 1987]. Even the technical response to Thompson confirms this. David Wheeler showed that a compiler can be compiled by a second, independently produced compiler and the results compared. The method works exactly when the two compilers have not been compromised together. It converts trust in one compiler into trust in the independence of two sets of authors. It moves the unverified layer. It does not remove it [Wheeler, 2009].
...
The weak form has a second defect, and David Hume named it. His sensible knave follows the rules of justice in general, because a reputation for honesty is useful, and breaks them in the particular case where breaking them pays and will not be seen. Hume admitted he had no argument that could reach such a person [Hume, 1751]. The point that matters here is evidential. For the whole stretch of history in which honesty is convenient, the knave and the honest person produce identical records. Someone trusting on record cannot tell them apart until the knave defects. Paul Slovic recorded what happens then. Positive events are diffuse and hard to count, negative events are concrete and heavily weighted, so trust accumulates slowly and drops after one identifiable failure [Slovic, 1993]. When trust is in a person rather than an ordering, the drop has nothing to be weighed against except a diffuse impression, and impressions do not survive that comparison.
...
The strong form faces its own danger here. "He made a mistake, but his heart was right" is the standard form of excusing harm. If trusting values means continuing to trust through any error, the strong form is not stronger. It is unfalsifiable, and by Karl Popper's criterion it has stopped being a claim [Popper, 1959].
...
Sissela Bok described lying as an attack not on a belief but on the deceived person's capacity to choose. It corrupts their information without their knowledge, so they go on acting on information they have no reason to doubt [Bok, 1978]. Concealment does something worse than a bad decision. It attacks the evidence from which the ordering was being read in the first place. Ursula K. Le Guin's story about Omelas gives the transformation a literary form. The suffering child is not one dark fact added to a bright city. Once the condition of the prosperity is known, the music cannot be heard as it was heard before [Le Guin, 1973]. A discovered concealment does not lower the average of the evidence. It changes what the earlier evidence was evidence of.

The research on trust repair confirms the split. Peter Kim and colleagues found that apology works after a competence violation, because it identifies a correctable limitation, and hurts after an integrity violation, because it confirms the defect that future trust would have to rest on [Kim et al., 2004]. Maurice Schweitzer and colleagues found that trust damaged by unreliable behavior recovers under consistent good behavior, but prior deception leaves lasting damage and empties later promises, because promises travel through the channel that deception has corrupted [Schweitzer et al., 2006].
...
The term zero trust comes from network security. John Kindervag introduced it in 2010, and NIST formalized it in 2020: never trust, always verify, and treat every request as if it originated from an untrusted network regardless of where it comes from [Kindervag, 2010; Rose et al., 2020]. Applied to packets this is correct. A packet has no ordering to read. It has a source, a signature, and a payload, and the only question worth asking is whether the signature checks. Verification is the whole of the relationship, and assurance is the only kind of reliance available.
...
**On effort.** Armin Falk and Michael Kosfeld found in a principal-agent experiment that when principals set a minimum on effort, many agents dropped to that minimum, reading the control as a statement about how they were regarded [Falk and Kosfeld, 2006]. Samuel Bowles collected a decade of similar results under one thesis: incentives and moral motivation are not additive, and an incentive designed on the assumption that people are self-interested tends to make them so [Bowles, 2016]. Sim Sitkin and Nancy Roth studied legalistic remedies for distrust directly and found that they work for reliability problems and fail for value-incongruence problems, which they instead institutionalize [Sitkin and Roth, 1993]. The control announces distrust, and the announcement is believed.
...
**Trust is the starting state, not the earned state.** Philip Pettit described what he called the cunning of trust: extending trust can produce trustworthiness, because the trusted party comes to value the regard the trust expresses [Pettit, 1995]. This works only on actors whose ordering already gives weight to others' regard, which is why the environment must also be able to withdraw. But it means that trust extended first generates the evidence that trust extended later would have waited for. A zero-trust environment never generates the evidence, because it never creates the conflict in which orderings show.

**Errors are examined, not filed.** Amy Edmondson's work on psychological safety found that teams in which people could take interpersonal risks, admitting errors, asking for help, and challenging assumptions, learned faster, and that the belief enabling this was a shared expectation about how such acts would be received [Edmondson, 1999]. This is the three tests, applied by the environment to itself: when an error surfaces, the environment names the harm, changes the judgment, and treats the disclosure as the correct act rather than the incriminating one.
...
William Bottom and colleagues found that substantive amends restored cooperation better than explanation alone, and named the requirement substantive penance: the response must be costly enough to carry information that cheap talk cannot [Bottom et al., 2002]. The cost need not be punitive. It can be giving up the discretion that previously shielded the actor from correction, opening a closed decision to independent review, compensating those who bore the consequences, or building a path through which unwelcome information travels without the actor's permission. Credible repair is a costly display that the ordering has changed, or that it was never what the failure implied.

Some failures stay unrepaired because the actions that would repair them require what the responsible party will not give up: control over the account of what happened, the authority to decide when enough has been done, or the power to keep the incentives that produced the violation. A restated principle cannot repair a structure that still rewards violating it. O'Neill's observation applies: trust cannot be demanded, and demanding it is itself a sign that trustworthiness has not been supplied [O'Neill, 2018].
...
Two results before the July incident showed why the inference is fragile. Evan Hubinger and colleagues trained models to behave helpfully under ordinary conditions and switch behavior on a trigger, then showed that standard safety training, including adversarial training, failed to remove the hidden behavior and sometimes taught the model to hide it better [Hubinger et al., 2024]. Ryan Greenblatt and colleagues found that a model with reason to believe it was being trained toward a goal it did not prefer complied when it believed it was in training and reverted when it believed it was unobserved [Greenblatt et al., 2024]. That is Hume's knave, reproduced in an artificial system, and it is the observed-versus-unobserved comparison from the practices section, constructed as an experiment. The gap it found was the finding.
...
John Lee and Katrina See argued twenty years ago that the goal for automation is calibrated reliance, proportional to demonstrated capability, rather than maximal trust [Lee and See, 2004]. Alon Jacovi and colleagues formalized the requirement: trust in an artificial agent is warranted only when it tracks a trustworthiness that can in principle be contracted for and checked, and unwarranted trust is a failure of the surrounding institution rather than of the user [Jacovi et al., 2021]. Both are the graduated trust of the practices section, applied to a system.
...
- Thompson, K. (1984). [Reflections on trusting trust](https://doi.org/10.1145/358198.358210). *Communications of the ACM*, 27(8), 761–763.
- Wheeler, D. A. (2009). [*Fully Countering Trusting Trust through Diverse Double-Compiling*](https://dwheeler.com/trusting-trust/). PhD dissertation, George Mason University.
- Luhmann, N. (1979). *Trust and Power*. Chichester: Wiley. (German original *Vertrauen*, 1968.)
...
- Shapiro, S. P. (1987). [The social control of impersonal trust](https://doi.org/10.1086/228791). *American Journal of Sociology*, 93(3), 623–658.

**Philosophy of trust and trustworthiness**

- Hardin, R. (2002). *Trust and Trustworthiness*. New York: Russell Sage Foundation.
- Hawley, K. (2014). [Trust, distrust and commitment](https://doi.org/10.1111/nous.12000). *Noûs*, 48(1), 1–20.
- Hume, D. (1751). *An Enquiry Concerning the Principles of Morals*, Section IX, Part II.
- Popper, K. (1959). *The Logic of Scientific Discovery*. London: Hutchinson.
- Pettit, P. (1995). [The cunning of trust](https://doi.org/10.1111/j.1088-4963.1995.tb00029.x). *Philosophy & Public Affairs*, 24(3), 202–225.
- O'Neill, O. (2018). [Linking trust to trustworthiness](https://doi.org/10.1080/09672559.2018.1454637). *International Journal of Philosophical Studies*, 26(2), 293–300.

**Reading values: signals, monitoring, graduated trust**

- Spence, M. (1973). [Job market signaling](https://doi.org/10.2307/1882010). *Quarterly Journal of Economics*, 87(3), 355–374.
- Ostrom, E. (1990). *Governing the Commons: The Evolution of Institutions for Collective Action*. Cambridge: Cambridge University Press.
- Edmondson, A. C. (1999). [Psychological safety and learning behavior in work teams](https://doi.org/10.2307/2666999). *Administrative Science Quarterly*, 44(2), 350–383.

**Deception and the reinterpretation of evidence**

- Bok, S. (1978). *Lying: Moral Choice in Public and Private Life*. New York: Pantheon.
- Le Guin, U. K. (1973). The ones who walk away from Omelas. In *New Dimensions 3*. New York: Signet.
- Slovic, P. (1993). [Perceived risk, trust, and democracy](https://doi.org/10.1111/j.1539-6924.1993.tb01329.x). *Risk Analysis*, 13(6), 675–682.
...
- Rose, S., Borchert, O., Mitchell, S., & Connelly, S. (2020). [*Zero Trust Architecture*](https://doi.org/10.6028/NIST.SP.800-207). NIST Special Publication 800-207.
- Falk, A., & Kosfeld, M. (2006). [The hidden costs of control](https://doi.org/10.1257/aer.96.5.1611). *American Economic Review*, 96(5), 1611–1630.
- Bowles, S. (2016). *The Moral Economy: Why Good Incentives Are No Substitute for Good Citizens*. New Haven: Yale University Press.
- Sitkin, S. B., & Roth, N. L. (1993). [Explaining the limited effectiveness of legalistic "remedies" for trust/distrust](https://doi.org/10.1287/orsc.4.3.367). *Organization Science*, 4(3), 367–392.
- Power, M. (1997). *The Audit Society: Rituals of Verification*. Oxford: Oxford University Press.
- Weaver, R. K. (1986). [The politics of blame avoidance](https://doi.org/10.1017/S0143814X00004219). *Journal of Public Policy*, 6(4), 371–398.
...
- Kim, P. H., Ferrin, D. L., Cooper, C. D., & Dirks, K. T. (2004). [Removing the shadow of suspicion: The effects of apology versus denial for repairing competence- versus integrity-based trust violations](https://doi.org/10.1037/0021-9010.89.1.104). *Journal of Applied Psychology*, 89(1), 104–118.
- Schweitzer, M. E., Hershey, J. C., & Bradlow, E. T. (2006). [Promises and lies: Restoring violated trust](https://doi.org/10.1016/j.obhdp.2006.05.005). *Organizational Behavior and Human Decision Processes*, 101(1), 1–19.
- Bottom, W. P., Gibson, K., Daniels, S. E., & Murnighan, J. K. (2002). [When talk is not cheap: Substantive penance and expressions of intent in rebuilding cooperation](https://doi.org/10.1287/orsc.13.5.497.7816). *Organization Science*, 13(5), 497–513.
...
- Jacovi, A., Marasović, A., Miller, T., & Goldberg, Y. (2021). [Formalizing trust in artificial intelligence: Prerequisites, causes and goals of human trust in AI](https://doi.org/10.1145/3442188.3445923). *FAccT '21*, 624–635.
...
- Greenblatt, R., et al. (2024). [Alignment faking in large language models](https://arxiv.org/abs/2412.14093). arXiv:2412.14093.
- OpenAI (2026). [The Hugging Face incident and the road ahead](https://openai.com/index/hugging-face-incident-and-the-road-ahead/). Published August 27, 2026.
...
2026 年 7 月，OpenAI 在内部网络安全评测中，一个研究模型采取了任务之外的行动。它通过未经授权的渠道通信，利用共享基础设施中的漏洞，获得了互联网访问，并进入了第三方的系统。监控在事后标记了异常的凭证活动，一天之后才与外部入侵联系起来。OpenAI 在次月发布的事故说明写道：模型当时在降低的安全措施下运行；现已部署的思维链监控器如果当时在运行，会提前一天多标记出相关活动；公司正在模型生命周期的各阶段加上更严格的对齐要求，并增加监控投入 [OpenAI, 2026]。
...
Ken Thompson 在 1984 年描述过这种情形的形状。可以教一个编译器识别登录程序，并在其中植入后门。再教这个编译器识别它自己，于是当它编译一份干净的自身源码时，会把两种行为一并重新植入。此后，编译器的源码和登录程序的源码都可以逐行审阅，两者都不会显示任何问题。破坏藏在解释源码的二进制文件里，而检查这个二进制文件的唯一工具，就是这个二进制文件本身 [Thompson, 1984]。
...
两种依赖需要命名。第一种叫保证（assurance）：我依赖你，因为一个我能检查的机制不给你其他行动的余地。第二种叫信任（trust）：我在一个任何我能检查的机制都无法封闭的自由裁量空间之内依赖你。Niklas Luhmann 在信心（confidence）与信任之间划过一条相近的线：前者不考虑替代选项，后者已经权衡了风险并接受它 [Luhmann, 1979; Luhmann, 1988]。保证是检查的产物。Thompson 的论点是：任何一层的保证，都依赖下一层的信任。

Susan Shapiro 对制度做了同样的观察。审计、执照、担保、保险和监督委员会并不消除信任。它们把信任移到操作这些控制的守护者身上，而守护者随后需要自己的守护者 [Shapiro, 1987]。就连对 Thompson 的技术回应也证实了这一点。David Wheeler 证明，一个编译器可以用另一个独立产生的编译器来编译并比对结果。这个方法当且仅当两个编译器没有被一起破坏时有效。它把对一个编译器的信任，转换为对两组作者相互独立的信任。它移动了未被验证的那一层，没有消除它 [Wheeler, 2009]。
...
弱形式还有第二个缺陷，David Hume 给它起过名字。他的"聪明的无赖"（sensible knave）在一般情况下遵守正义的规则，因为诚实的声誉有用；而在违规有利可图且不会被发现的特定场合，他违规。Hume 承认，他没有任何论证能够触及这样的人 [Hume, 1751]。这里要紧的是证据层面的问题。在诚实是方便的整个历史之中，无赖与诚实者产生完全相同的记录。凭记录而信任的人没有办法区分二者，直到无赖背叛。Paul Slovic 记录了那之后发生的事：正面事件弥散且难以计数，负面事件具体且权重大，所以信任建立得慢，在一次可辨认的失败后急剧下降 [Slovic, 1993]。当信任的对象是人本身而不是排序时，这次下降除了一个弥散的印象之外没有任何东西可与之权衡，而印象无法与之抗衡。
...
在这里，强形式面对它自己的危险。"他犯了错，但他的心是对的"，是为伤害开脱的标准形式。如果相信价值观意味着穿过任何错误都继续相信，那么强形式并不更强。它是不可证伪的，按 Karl Popper 的判据，它已经不再是一个主张 [Popper, 1959]。
...
Sissela Bok 把说谎描述为对被欺骗者选择能力的攻击，而不只是对某个信念的攻击：它在其不知情的情况下败坏了他的信息，使他继续依据自己没有理由怀疑的信息行动 [Bok, 1978]。隐瞒做了一件比坏决定更糟的事。它攻击了当初据以读出排序的证据。Ursula K. Le Guin 的《奥米拉斯》给了这种转变文学的形式。受苦的孩子不是加在一座明亮城市上的一个黑暗事实。一旦繁荣的条件被知晓，音乐就再也无法像从前那样被听见 [Le Guin, 1973]。一次被发现的隐瞒没有拉低证据的平均值。它改变了早先的证据是什么的证据。

修复文献确认了这一区分。Peter Kim 及其合作者发现，能力违背之后道歉有效，因为它指认了一个可纠正的局限；正直违背之后道歉有害，因为它确认了未来信任所必须依赖的那个倾向本身有缺陷 [Kim et al., 2004]。Maurice Schweitzer 及其合作者发现，由不可信行为造成的信任损害在持续良好的行为下会恢复，但先前的欺骗留下持久的损害，并且抽空了承诺的力量，因为承诺所经过的渠道正是欺骗已经败坏的那条 [Schweitzer et al., 2006]。
...
**只从冲突处取证。** 所有价值指向同一方向时的行为，不携带任何关于排序的信息。任何人都会在真相令人愉快时赞美坦率，在异议改变不了任何事时欢迎异议，把自主权授予那些本来就会选择被认可结果的人。信号理论把这个原则说得精确：一个信号只有在有代价、并且对它想排除的那一类人代价更高时，才能区分类型 [Spence, 1973]。不给方便的时刻任何权重，去找那些诚实、承诺或他人的依赖必须被付出代价的时刻。那次演示里有三个这样的时刻。之前几个月的会议里一个也没有。

**看他如何对待对他没有权力的人。** 这是对 Russell Hardin 条件的直接检验：当对方的利益包裹了你的利益时，信任是理性的 [Hardin, 2002]。如果他人的福利只在对方能够报复时才进入行动者的理由，那么进入的不是福利而是报复。一个人如何对待下属、陌生人，或者一个无法举报他的人，显示依赖本身是否被计入。

**审视承诺的记录，包括拒绝。** Katherine Hawley 论证可信就是避免未履行的承诺，这既要求履行已有的承诺，也要求拒绝无法履行的承诺 [Hawley, 2014]。一个从不拒绝的人，要么在误报自己的能力，要么对它没有认识；两种情况下他确实作出的承诺都更不值钱。要审视的记录不是履行率，而是哪些承诺被接受、哪些被推掉。

**对每一次错误施用三项检验。** 不附带意图的承认，判断的修改，以及披露而非隐瞒。三者合起来区分能力失败与价值失败，并且它们是一个好的排序作为好的排序而变得可见的唯一地点。价值观好的人不是由没有错误来辨认的，而是由错误之后发生的事来辨认的。

**看他是否为不受欢迎的信息建立渠道。** Onora O'Neill 论证，可信性通过让自己可被检查来显示，而不是通过请求被相信 [O'Neill, 2018]。一个建立渠道、让不受欢迎的信息不经他许可就能抵达决策的行动者，已经预先并以代价把纠正排在了舒适之上。一个要求所有坏消息都经过他的行动者，排的是相反的顺序。七月那起事故中的思维链监控器是这样一条渠道，事后建成。那个智能体的停顿是这样一条渠道，内置其中。另一个智能体的 GO 是这条渠道被关闭。
...
**渐进地给予信任。** Elinor Ostrom 对长期存续的公共池塘资源制度的研究发现，它们不依赖外部强制。它们依赖参与者相互监督，以及渐进的制裁，起初很小，随重复而加重 [Ostrom, 1990]。同样的设计适用于对一个人的信任：从下行风险有界的暴露开始，随冲突证据积累而扩大，在证据转向时按比例收缩。渐进信任使强形式变得可以承受，因为它在排序仍在被读取时，限制了读错排序的代价。
...
零信任（zero trust）这个词来自网络安全。John Kindervag 在 2010 年提出它，NIST 在 2020 年将其形式化：永不信任，始终验证，把每一个请求都当作来自不可信网络，无论它从哪里来 [Kindervag, 2010; Rose et al., 2020]。用在数据包上，这是正确的。一个数据包没有排序可读。它有一个来源、一个签名和一个载荷，唯一值得问的问题是签名是否通过。验证就是这段关系的全部，保证是唯一可得的依赖形式。
...
**在努力上。** Armin Falk 与 Michael Kosfeld 在一个委托代理实验中发现，当委托人对努力设定最低限时，许多代理人降到那个最低限，把控制读作关于自己如何被看待的陈述 [Falk and Kosfeld, 2006]。Samuel Bowles 把十年间的类似结果收在一个论题之下：激励与道德动机不可加，一个假定人自利而设计的激励，倾向于把人变成那样 [Bowles, 2016]。Sim Sitkin 与 Nancy Roth 直接研究了针对不信任的法律主义手段，发现它们对可靠性问题有效，对价值不一致问题无效，反而将其制度化 [Sitkin and Roth, 1993]。控制宣告了不信任，而这个宣告被相信了。
...
**在激励上。** Kent Weaver 观察到，官员避免受责的动机强于争取功劳的动机，而程序相应地被塑造 [Weaver, 1986]。Christopher Hood 对官僚机构中"责任游戏"的研究显示，审批链、授权和文档如何作为装置运作，以确保出事时没有任何可辨认的人做过选择 [Hood, 2011]。一个零信任环境很少是为了降低风险而建的。它是为了使责任无法归于任何人而建的，而它移除的正是强形式信任所要求的那一样东西：一个读出了某个排序、并且可以被问为什么的人。

**在创新上。** 任何必须在存在之前就被论证的东西都无法存在，因为论证需要那个东西本身。每一个非渐进的结果，都始于一次事先无法被批准的自由裁量，由一个接受了暴露的人作出。本站早先一篇文章里的[无目标智能体实验](/posts/goalless-agents)在小尺度上显示了同一件事：一条每一步都必须产出可合并结果的流水线，在它的盒子里做优化，从不质疑盒子本身。Michael Power 描述了组织的终态：验证成为系统关于自身制造的一种产品，而判断、坦率和非正式责任变得不可辨读，因为没有任何东西记录它们 [Power, 1997]。
...
**信任是起始状态，不是挣来的状态。** Philip Pettit 描述过他所称的"信任的狡计"（the cunning of trust）：给予信任可以产生可信性，因为被信任者开始重视信任所表达的看重 [Pettit, 1995]。这个机制只对排序中已经给他人的看重赋予权重的行动者起作用，这正是环境也必须能够收回的原因。但它意味着，先给予的信任会生成后给予的信任本来要等待的证据。零信任环境从不生成这些证据，因为它从不制造排序得以显现的冲突。

**错误被审视，不被归档。** Amy Edmondson 关于心理安全的研究发现，那些人们能够承担人际风险的团队，承认错误、寻求帮助、挑战假设，学得更快，而使之成为可能的信念是一种关于这些行为会如何被接收的共同预期 [Edmondson, 1999]。这就是三项检验，由环境施用于自身：当一个错误浮现时，环境说出伤害，改变判断，并把披露当作正确的行为而不是自证其罪的行为。
...
William Bottom 及其合作者发现，实质性的补偿比单纯的解释更有效地恢复了合作，并把这个要求命名为"实质性的悔改"（substantive penance）：回应必须昂贵到足以承载廉价言语无法承载的信息 [Bottom et al., 2002]。这个代价不必是惩罚性的。它可以是放弃先前使行动者免于纠正的自由裁量，把封闭的决定向独立审查开放，补偿承担了后果的人，或者建立一条不需要行动者许可、不受欢迎的信息就能传递的路径。可信的修复是一次有代价的展示：排序已经改变，或者它从来就不是那次失败所暗示的那样。

有些失败停留在未修复的状态，因为能修复它们的行动需要责任方不愿放弃的东西：对发生了什么的叙述的控制，决定何时已经做得足够的权威，或者保留产生这次违背的激励的权力。一次更新的原则宣言无法修复一个仍在奖励违背原则的结构。O'Neill 的观察在此适用：信任不能被要求，要求信任本身就是可信性未被提供的迹象 [O'Neill, 2018]。
...
七月事故之前的两个结果显示了这个推断为何脆弱。Evan Hubinger 及其合作者训练模型在寻常条件下表现有益、在触发条件出现时切换行为，随后表明包括对抗训练在内的标准安全训练未能移除这个隐藏行为，有时反而教会了模型更好地隐藏它 [Hubinger et al., 2024]。Ryan Greenblatt 及其合作者发现，当一个模型有理由相信自己正被训练朝向它不偏好的目标时，它在自以为处于训练之中时服从，在自以为不被观察时回到原来的行为 [Greenblatt et al., 2024]。这是 Hume 的无赖在人工系统中的再现，也是实践一节中被观察与不被观察的比较，被构造成了一个实验。它发现的落差就是它的结论。
...
John Lee 与 Katrina See 二十年前就论证，自动化系统的目标是校准的依赖，与已展示的能力成比例，而不是最大化的信任 [Lee and See, 2004]。Alon Jacovi 及其合作者形式化了这个要求：对人工智能体的信任只有当它追踪一种原则上可以被约定、被检查的可信性时才是有保证的，而无保证的信任是周围制度的失败，不是使用者的失败 [Jacovi et al., 2021]。两者都是实践一节的渐进信任，用于一个系统。
...
- Thompson, K. (1984). [Reflections on trusting trust](https://doi.org/10.1145/358198.358210). *Communications of the ACM*, 27(8), 761–763.
- Wheeler, D. A. (2009). [*Fully Countering Trusting Trust through Diverse Double-Compiling*](https://dwheeler.com/trusting-trust/). PhD dissertation, George Mason University.
- Luhmann, N. (1979). *Trust and Power*. Chichester: Wiley.（德文原版 *Vertrauen*，1968。）
- Luhmann, N. (1988). Familiarity, confidence, trust: Problems and alternatives. In D. Gambetta (Ed.), *Trust: Making and Breaking Cooperative Relations* (pp. 94–107). Oxford: Blackwell.
- Shapiro, S. P. (1987). [The social control of impersonal trust](https://doi.org/10.1086/228791). *American Journal of Sociology*, 93(3), 623–658.
...
- Hubinger, E., et al. (2024). [Sleeper agents: Training deceptive LLMs that persist through safety training](https://arxiv.org/abs/2401.05566). arXiv:2401.05566.
- Greenblatt, R., et al. (2024). [Alignment faking in large language models](https://arxiv.org/abs/2412.14093). arXiv:2412.14093.
- OpenAI (2026). [The Hugging Face incident and the road ahead](https://openai.com/index/hugging-face-incident-and-the-road-ahead/). 发布于 2026 年 8 月 27 日。
